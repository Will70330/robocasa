...
class LayoutType(IntEnum):
    ...
    LAYOUT_MESSYMEM_FOUR_CABINETS = 67
    LAYOUT_MESSYMEM_THREE_UPPERS = 68
    LAYOUT_MESSYMEM_TWO_UPPERS_MINIMAL = 69
    LAYOUT_MESSYMEM_KITCHEN_ROW = 70
    LAYOUT_MESSYMEM_DRAWERS_4X2 = 71
